...
public class SpaceController {
    ...
    @Parameters({
            ...
            @Parameter(name = "roomCapacity", description = "n인 이상의 n", example = "6"),
    ...
    public ResponseEntity<Response<List<SpaceResponseDto.MeetingRoomDto>>> getMeetingRoomList(
        ...
        return ResponseEntity.ok(Response.success(spaceService.getMeetingRoomList(branchName, roomCapacity,
                projectorExists, canVideoConference, isPrivate, sortTarget, sortDirection)));
    }
}
